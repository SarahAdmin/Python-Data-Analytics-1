...
average3 = bsr_df["Neither satisfied nor disastified"].mean() 
average4 = bsr_df["Disatisfied"].mean()
average5 = bsr_df["Very disatisfied"].mean() 
customerFac = bsr_df["Customer Satisfaction (out of 5)"].mean()
